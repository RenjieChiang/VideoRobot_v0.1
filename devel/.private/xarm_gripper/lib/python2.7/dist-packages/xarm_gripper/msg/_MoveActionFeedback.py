...
"""autogenerated by genpy from xarm_gripper/MoveActionFeedback.msg. Do not edit."""
import sys
...
class MoveActionFeedback(genpy.Message):
  _md5sum = "a8c9c15cfff2a104f2cabff53e78575c"
  _type = "xarm_gripper/MoveActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','xarm_gripper/MoveFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = xarm_gripper.msg.MoveFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = xarm_gripper.msg.MoveFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.feedback.current_pulse
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.current_pulse,) = _get_struct_f().unpack(str[start:end])
      return self
