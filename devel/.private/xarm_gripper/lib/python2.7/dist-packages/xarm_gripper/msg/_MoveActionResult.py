...
"""autogenerated by genpy from xarm_gripper/MoveActionResult.msg. Do not edit."""
import sys
...
class MoveActionResult(genpy.Message):
  _md5sum = "8a10bafe50020bbddabfa9f08e85104a"
  _type = "xarm_gripper/MoveActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','xarm_gripper/MoveResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = xarm_gripper.msg.MoveResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = xarm_gripper.msg.MoveResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_Bh().pack(_x.result.success, _x.result.err_code))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.success, _x.result.err_code,) = _get_struct_Bh().unpack(str[start:end])
